...
namespace EgycastApi.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostLikes_AspNetUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommentLikes_AspNetUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentLikes_CommentId_CreatorId",
                table: "CommentLikes",
                columns: new[] { "CommentId", "CreatorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CommentLikes_CreatorId",
                table: "CommentLikes",
                column: "CreatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostLikes_CreatorId",
                table: "PostLikes",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_PostLikes_PostId_CreatorId",
                table: "PostLikes",
                columns: new[] { "PostId", "CreatorId" },
                unique: true);
